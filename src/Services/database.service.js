...
var User_Collection = process.env.User_Collection;
var Category_Collection = process.env.Category_Collection;
var Product_Collection = process.env.Product_Collection;
function connectToDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var client, db, usersCollection, categoriesCollection, productsCollection;
